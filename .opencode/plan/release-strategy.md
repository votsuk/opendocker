...
**Current State:**
- Package: `opendocker` v0.3.0 (local), v0.2.0 (npm)
- Repository: `votsuk-911/opendocker`
...
When ready to implement, move this file to the project root:
```bash
cp .opencode/plan/release-strategy.md PLAN.md
```
